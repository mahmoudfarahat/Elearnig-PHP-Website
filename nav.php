                 ...
                 <li class="nav-item">
                  ...
                  <ul class="navbar-nav">
                    <li class="nav-item mx-2 align-self-center">
                      ...
                      <li class="nav-item mx-2">
                        <a class="nav-link btn btn-primary signup-btn " href="logout.php">Sign out</a>
                      </li>
                      <li class="nav-item mx-2 align-self-center"   >
                        <a href="<?php if (isset($_SESSION['role']) 	And $_SESSION['role'] ==1  )  echo 'instructorprofile.php'  ?> 
                        <?php if (isset($_SESSION['role']) 	And $_SESSION['role'] ==2  )  echo 'studentprofile.php'  ?>  ">
